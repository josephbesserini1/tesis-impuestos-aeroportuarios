  ...
  Future<void> _cargar() async {
    ...
    try {
      final data = await _supabase
          .from('hangares')
          .select('id, codigo_hangar, estado, capacidad, aeropuertos(nombre, codigo)')
          .order('codigo_hangar');
      setState(() {
                        ...
                        return Padding(
                          ...
                          child: Card(
                            child: ListTile(
                              ...
                              title: Text(h['codigo_hangar'] as String, style: const TextStyle(fontWeight: FontWeight.w600)),
                              subtitle: Text([
...
class _FormularioHangarState extends State<_FormularioHangar> {
  ...
  Future<void> _cargarAeropuertos() async {
    try {
      final data = await _supabase.from('aeropuertos').select('id, nombre, codigo').order('nombre');
      setState(() {
    ...
    return SingleChildScrollView(
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            Text('Registrar hangar', style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold)),
            const SizedBox(height: 16),
            TextFormField(
              controller: _codigoController,
              textCapitalization: TextCapitalization.characters,
              decoration: const InputDecoration(labelText: 'Codigo de hangar', hintText: 'Ej: H1'),
            ...
            DropdownButtonFormField<String>(
              ...
              onChanged: (value) => setState(() => _estado = value ?? 'Disponible'),
            ),
            const SizedBox(height: 12),
